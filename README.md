...
`claims_audit.py` (32), `check_errata.py` (78, needs pypdf), `check_route.py` (92).
...
| [`verification/check_route.py`](verification/check_route.py) | **[ROUTE.md](ROUTE.md) の九段階は、他の文書と食い違わないか。** | 92 |
